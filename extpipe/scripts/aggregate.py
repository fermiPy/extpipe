...
def main():
    ...
    parser.add_argument('--files_per_job', type=int, default=100)
    ...
    if args.batch:
        ...
        njob = len(files)/args.files_per_job+1

        print(files)
        
        for i in range(njob):
            job_files = ' '.join(files[i*args.files_per_job:(i+1)*args.files_per_job])
